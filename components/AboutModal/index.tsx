          ...
          >
            <View className='pb-[100px]'>
              ...
              >
                ...
                et qui reprehenderit soluta, iusto incidunt in eius culpa
                laudantium dolore voluptas nisi, quaerat cupiditate similique
                exercitationem, modi vitae voluptate? Natus ab deleniti dolorum
                odio officia voluptatibus commodi laborum sed facilis deserunt
                error quia quas rem provident porro cum inventore, ipsam, hic
                soluta ut? Quaerat iusto soluta ratione, similique in quas
                voluptate nobis quis doloremque vel odit dolores non perferendis
                qui perspiciatis, dolore magnam. Velit qui repellendus quia quis
                modi nemo explicabo dolorem facere delectus recusandae obcaecati
                officiis cupiditate tempora, aperiam, amet, blanditiis deleniti
              ...
              >
                ...
                exercitationem, modi vitae voluptate? Natus ab deleniti dolorum
                odio officia voluptatibus commodi laborum sed facilis deserunt
                error quia quas. dolore voluptas nisi, quaerat cupiditate
                similique exercitationem, modi vitae voluptate? Natus ab
                deleniti dolorum odio officia voluptatibus commodi laborum sed
                facilis deserunt error quia quas.
              </Text>
              <Text
                className='text-[12px] leading-[25px] mt-6'
                style={{ fontFamily: 'font_400' }}
