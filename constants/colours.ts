export const default_light_backgrounds = {
  ...
  background_variant_2: '#473bf0', // blue-ish
  background_variant_3: '#CDCDE0', // white-ish-greyish
  background_variant_4: 'rgba(255, 160, 1, 0.8)', // white-ish-greyish
  background_variant_5: '#dbeafe', // light-blue
  background_variant_6: 'rgba(29, 29, 43, 0.25)', // transparent(showing dark_blue/slate background)
};

export const default_light_texts = {
  text_variant_1: '#6b7280', // black
  text_variant_2: '#473bf0', // blue-ish
  text_variant_3: '#CDCDE0', // white-ish-greyish
  text_variant_4: 'rgba(255, 160, 1, 0.8)', // white-ish-greyish
  text_variant_5: '#ffffff', // black
  text_variant_6: '#dbeafe', // light-blue
};
